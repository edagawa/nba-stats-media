...
TEAM_DETAILS = { "Atlanta Hawks": {"conference": "Eastern", "division": "Southeast", "arena": "State Farm Arena", "location": "Atlanta, Georgia", "championships": "1 (1958)"}, "Boston Celtics": {"conference": "Eastern", "division": "Atlantic", "arena": "TD Garden", "location": "Boston, Massachusetts", "championships": "18 (Most recent: 2024)"}, "Brooklyn Nets": {"conference": "Eastern", "division": "Atlantic", "arena": "Barclays Center", "location": "Brooklyn, New York", "championships": "0"}, "Charlotte Hornets": {"conference": "Eastern", "division": "Southeast", "arena": "Spectrum Center", "location": "Charlotte, North Carolina", "championships": "0"}, "Chicago Bulls": {"conference": "Eastern", "division": "Central", "arena": "United Center", "location": "Chicago, Illinois", "championships": "6 (Most recent: 1998)"}, "Cleveland Cavaliers": {"conference": "Eastern", "division": "Central", "arena": "Rocket Mortgage FieldHouse", "location": "Cleveland, Ohio", "championships": "1 (2016)"}, "Dallas Mavericks": {"conference": "Western", "division": "Southwest", "arena": "American Airlines Center", "location": "Dallas, Texas", "championships": "1 (2011)"}, "Denver Nuggets": {"conference": "Western", "division": "Northwest", "arena": "Ball Arena", "location": "Denver, Colorado", "championships": "1 (2023)"}, "Detroit Pistons": {"conference": "Eastern", "division": "Central", "arena": "Little Caesars Arena", "location": "Detroit, Michigan", "championships": "3 (Most recent: 2004)"}, "Golden State Warriors": {"conference": "Western", "division": "Pacific", "arena": "Chase Center", "location": "San Francisco, California", "championships": "7 (Most recent: 2022)"}, "Houston Rockets": {"conference": "Western", "division": "Southwest", "arena": "Toyota Center", "location": "Houston, Texas", "championships": "2 (Most recent: 1995)"}, "Indiana Pacers": {"conference": "Eastern", "division": "Central", "arena": "Gainbridge Fieldhouse", "location": "Indianapolis, Indiana", "championships": "0"}, "LA Clippers": {"conference": "Western", "division": "Pacific", "arena": "Intuit Dome", "location": "Inglewood, California", "championships": "0"}, "Los Angeles Lakers": {"conference": "Western", "division": "Pacific", "arena": "Crypto.com Arena", "location": "Los Angeles, California", "championships": "17 (Most recent: 2020)"}, "Memphis Grizzlies": {"conference": "Western", "division": "Southwest", "arena": "FedExForum", "location": "Memphis, Tennessee", "championships": "0"}, "Miami Heat": {"conference": "Eastern", "division": "Southeast", "arena": "Kaseya Center", "location": "Miami, Florida", "championships": "3 (Most recent: 2013)"}, "Milwaukee Bucks": {"conference": "Eastern", "division": "Central", "arena": "Fiserv Forum", "location": "Milwaukee, Wisconsin", "championships": "2 (Most recent: 2021)"}, "Minnesota Timberwolves": {"conference": "Western", "division": "Northwest", "arena": "Target Center", "location": "Minneapolis, Minnesota", "championships": "0"}, "New Orleans Pelicans": {"conference": "Western", "division": "Southwest", "arena": "Smoothie King Center", "location": "New Orleans, Louisiana", "championships": "0"}, "New York Knicks": {"conference": "Eastern", "division": "Atlantic", "arena": "Madison Square Garden", "location": "New York, New York", "championships": "2 (Most recent: 1973)"}, "Oklahoma City Thunder": {"conference": "Western", "division": "Northwest", "arena": "Paycom Center", "location": "Oklahoma City, Oklahoma", "championships": "1 (1979 as Seattle SuperSonics)"}, "Orlando Magic": {"conference": "Eastern", "division": "Southeast", "arena": "Kia Center", "location": "Orlando, Florida", "championships": "0"}, "Philadelphia 76ers": {"conference": "Eastern", "division": "Atlantic", "arena": "Wells Fargo Center", "location": "Philadelphia, Pennsylvania", "championships": "3 (Most recent: 1983)"}, "Phoenix Suns": {"conference": "Western", "division": "Pacific", "arena": "Footprint Center", "location": "Phoenix, Arizona", "championships": "0"}, "Portland Trail Blazers": {"conference": "Western", "division": "Northwest", "arena": "Moda Center", "location": "Portland, Oregon", "championships": "1 (1977)"}, "Sacramento Kings": {"conference": "Western", "division": "Pacific", "arena": "Golden 1 Center", "location": "Sacramento, California", "championships": "1 (1951 as Rochester Royals)"}, "San Antonio Spurs": {"conference": "Western", "division": "Southwest", "arena": "Frost Bank Center", "location": "San Antonio, Texas", "championships": "5 (Most recent: 2014)"}, "Toronto Raptors": {"conference": "Eastern", "division": "Atlantic", "arena": "Scotiabank Arena", "location": "Toronto, Ontario", "championships": "1 (2019)"}, "Utah Jazz": {"conference": "Western", "division": "Northwest", "arena": "Delta Center", "location": "Salt Lake City, Utah", "championships": "0"}, "Washington Wizards": {"conference": "Eastern", "division": "Southeast", "arena": "Capital One Arena", "location": "Washington, D.C.", "championships": "1 (1978 as Washington Bullets)"}, }
...
def generate_team_summary(s1_stats, s2_stats):
    ...
    if best_rank <= 10:
        ...
        if best_strength_stat == 'OFF EFF' and s2_stats['OFF EFF'] > s1_stats['OFF EFF']: positive_sentence += " 前年からさらに磨きがかかり、リーグを代表する攻撃力を手に入れました。"
        elif best_strength_stat == 'DEF EFF' and s2_stats['DEF EFF'] < s1_stats['DEF EFF']: positive_sentence += " 鉄壁の守備は前年からさらに堅固なものとなり、相手チームを苦しめています。"
    ...
    if worst_rank >= 21 and best_strength_stat != biggest_challenge_stat:
        ...
        if biggest_challenge_stat == 'DEF EFF' and s2_stats['DEF EFF'] > s1_stats['DEF EFF']: challenge_sentence += " 前年に比べ失点が増加傾向にあり、ここを修正できれば一気に上位進出が見えてきます。"
        elif biggest_challenge_stat == 'OFF EFF' and s2_stats['OFF EFF'] < s1_stats['OFF EFF']: challenge_sentence += " やや得点力に課題を残しており、攻撃のバリエーションを増やすことが期待されます。"
...
def generate_comparison_pages(df_s1, df_s2, df_players, video_data, env, player_team_map, base_path):
    ...
    for team in all_teams:
        try:
            stats1 = df_s1_indexed.loc[team]; stats2 = df_s2_indexed.loc[team]
            stats_for_graph1 = stats1[stats_to_compare]; stats_for_graph2 = stats2[stats_to_compare]
            x = np.arange(len(stats_to_compare)); width = 0.35
            fig, ax = plt.subplots(figsize=(10, 6))
            ax.bar(x - width/2, stats_for_graph1, width, label='2023-24'); ax.bar(x + width/2, stats_for_graph2, width, label='2024-25')
...
def generate_player_pages(env, scoring_timeline_data, df_s1_raw, df_s2_raw, player_team_map, base_path):
    ...
    def generate_player_comment(player_name, season_str_long, player_season_timeline):
        ...
        if best_quarter == 4 and (q4_points / total_points) > 0.3:
            comment_parts.append(f"{player_name}選手は、試合の勝敗が決まる第4クォーターに最も得点を集中させるクラッチパフォーマーです。"); comment_parts.append(f"総得点の{total_points:.0f}点のうち、実に{q4_points:.0f}点をこの時間帯で記録しており、勝負強さが際立っています。")
        elif best_quarter == 1 and (q1_points / total_points) > 0.3:
    ...
    for index, player_data in df_merged.iterrows():
        ...
        try:
            ...
            plt.close(fig) # ★ 修正点: figを明示的に指定して閉じる
            ...
            for season_str_short in ["23-24", "24-25"]:
                ...
                ax_attempts.set_title(f'{player_name} - Shot Attempts (Made/Miss) Timeline ({season_str_long})'); ax_attempts.set_xlabel('Game Minute'); ax_attempts.set_ylabel('Number of Attempts'); ax_attempts.set_xticks([0, 12, 24, 36, 47]); ax_attempts.grid(axis='y', linestyle='--', alpha=0.7); ax_attempts.legend()
                plt.savefig(f"output/images/players/timeline_attempts_{season_str_short}_{player_filename}.svg", format="svg")
                plt.close(fig_attempts) # ★ 修正点: fig_attemptsを明示的に指定して閉じる
                ...
                fig_points, ax_points = plt.subplots(figsize=(15, 7))
                ax_points.bar(points_agg['absolute_minute'], points_agg.get('3PT', 0), color='#1f77b4', label='3-Pointers'); ax_points.bar(points_agg['absolute_minute'], points_agg.get('2PT', 0), bottom=points_agg.get('3PT', 0), color='#ff7f0e', label='2-Pointers'); ax_points.bar(points_agg['absolute_minute'], points_agg.get('FT', 0), bottom=points_agg.get('3PT', 0) + points_agg.get('2PT', 0), color='#2ca02c', label='Free Throws')
                ax_points.set_title(f'{player_name} - Points Scored Timeline ({season_str_long})'); ax_points.set_xlabel('Game Minute'); ax_points.set_ylabel('Points Scored'); ax_points.set_xticks([0, 12, 24, 36, 47]); ax_points.grid(axis='y', linestyle='--', alpha=0.7); ax_points.legend()
                plt.savefig(f"output/images/players/timeline_points_{season_str_short}_{player_filename}.svg", format="svg")
                plt.close(fig_points) # ★ 修正点: fig_pointsを明示的に指定して閉じる
